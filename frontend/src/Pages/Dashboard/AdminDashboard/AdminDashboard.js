...
import EditBook from './Components/EditBook'; // Import the EditBook component here
...
function AdminDashboard() {
    const [active, setActive] = useState("addbook"); // Set initial active state to "addbook"
        ...
        <div className="dashboard">
            <div className="dashboard-card">
                ...
                <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
                    ...
                    <p className={`dashboard-option ${active === "editbook" ? "clicked" : ""}`} onClick={() => { setActive("editbook"); setSidebar(false) }}><BookIcon className='dashboard-option-icon' />Edit Book</p> {/* New option for Edit Book */}
                ...
                <div className="dashboard-option-content">
                    ...
                    <div className="dashboard-editbook-content" style={active !== "editbook" ? { display: 'none' } : {}}> {/* New content block for Edit Book */}
                        <EditBook />
                    </div>
